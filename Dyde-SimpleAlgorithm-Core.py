...
def upnew():
   image1 = pygame.image.load(os.path.dirname(os.path.realpath(__file__)) + r"\Image\Dyde-SimpleAlgorithm-Core-Background.bmp")
...
def splitChannel(srcMusicFile,desMusicFile,Aleft,Aright,SRate): # SRate=0 means default.
   ...
   mixed_data1 = np.array(left) - np.array(right)
   mixed_data2 = np.array(right) - np.array(left)
   pygame.display.update()
...
icon = pygame.image.load(os.path.dirname(os.path.realpath(__file__)) + r"\Image\Dyde-SimpleAlgorithm-Core.ico") 
pygame.display.set_icon(icon)
pygame.display.set_caption("Dyde Vocal-Cut Module")
image1 = pygame.image.load(os.path.dirname(os.path.realpath(__file__)) + r"\Image\Dyde-SimpleAlgorithm-Core-Background.bmp")
image2 = pygame.transform.scale(image1,(window_wid,window_hei))
window.blit(image2,(0,0))
pygame.display.flip()
...
# End of source code file of Dyde-SimpleAlgorithm-Core. 
